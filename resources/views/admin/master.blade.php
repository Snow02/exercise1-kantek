...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i>{!! Auth::guard('admin')->user()->name !!} </a>
                        <li class="divider"></li>
                        <li><a href="{{route('admin.logout')}}" id="btn-logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="http://exercise-kantek.local/ckfinder/ckfinder.html?CKEditor=content&CKEditorFuncNum=207&langCode=vi"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('admin.index')}}">List Admin</a>
                                </li>
                                <li>
    ...
    <script src="admin/js/select-multi.js"></script>
